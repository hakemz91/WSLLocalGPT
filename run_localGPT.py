...
Do not repeat what you have answered before. And please provide detailed answer.
    ...
    while True:
        ...
        # Print the result with color formatting
        print("\n\n> Question:")
        print("\033[38;5;214m" + query + "\033[0m")  # Light Orange
        print("\n> Answer:")
        print("\033[38;5;117m" + answer + "\033[0m")  # Light Blue

        if show_sources:
            # Print the relevant sources used for the answer with light blue color
            print("----------------------------------SOURCE DOCUMENTS---------------------------")
            for document in docs:
                print("\n> " + "\033[93m" + document.metadata["source"] + "\033[0m" + ":")  # Light Yellow
