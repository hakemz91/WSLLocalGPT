...
# Custom Instructor Model, use less VRAW than default but not that accurate in understanding data, avoid this if you can
...
#You can add more models you want
#MODEL_ID = ""
#MODEL_BASENAME = "model.safetensors"
