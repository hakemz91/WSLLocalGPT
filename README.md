...
Just edit the model id in the constants.txt to the model id that you want and then save the file, must be be llama2 based model. And use the bloke 4 bit quantized GPTQ model. However the default Nous-Hermes model is the best, have very less halucination and took only like 5 seconds to answer question using my RTX 3060 12 GB.
